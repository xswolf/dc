...
<div class="container-fluid">
    ...
    <div class="wpBox">
        <div class="hd">
            <div class="text-right"><a class="btn btn-primary" href="<?php echo U('saveTable');?>">添加桌号</a></div>
        </div>
        <div class="bd">
            <table class="table table-hover table-bordered">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><img src="<?php echo ($vo["img"]); ?>" alt=""/></td>
                        <td>
                            <a class="btn btn-info" href="<?php echo U('saveTable');?>?id=<?php echo ($vo["id"]); ?>">编辑</a>
                            <a class="btn btn-danger j-delTable" data-table="shop_table" data-id="<?php echo ($vo["id"]); ?>" href="javascript:;">删除</a>
                        </td>
